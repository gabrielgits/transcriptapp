...
abstract class NotificationsRepository {
  ...
  Future<Result<List<NotificationModel>>> getList();
  ...
  Future<Result<NotificationModel>> getItem(int id);
  ...
  /// - Throws an exception if the network request fails.
  Future<Result<NotificationModel>> saveItem(Map<String, dynamic> jsonData);
  ...
  /// Throws an exception if the item is not found or the network request fails.
  Future<Result<int>> deleteItem(int id);
}
