...
abstract class $AnswerModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String line, String answer, int questionId});
}
...
/// @nodoc
@JsonSerializable()
class _$AnswerModelImpl with DiagnosticableTreeMixin implements _AnswerModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AnswerModel(id: $id, line: $line, answer: $answer, questionId: $questionId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, line, answer, questionId);
...
abstract class _AnswerModel implements AnswerModel {
  const factory _AnswerModel(
      ...
      required final int questionId}) = _$AnswerModelImpl;
